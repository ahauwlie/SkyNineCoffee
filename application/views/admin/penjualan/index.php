          ...
          <table id="productTable" class="table table-bordered table-hover">
            ...
            <?php
              foreach ($penjualan as $row) {
                  echo "<tr>";
                  echo "<td>".$row['id_tr']."</td>";
                  echo "<td>".$row['id_us']."</td>";
                  echo "<td>".$row['id_disc']."</td>";
                  echo "<td>".$row['date_tr']."</td>";
                  echo "<td>".$row['total_tr']."</td>";
                  echo "<td class='text-center'>";
                  echo "      <a href='".site_url('Penjualan_admin/detail/').$row['id_tr']."'><i class='fa fa-eye'></i></a> ";
                  echo "      <a href='#' data-id='".$row['id_tr']."' data-name='".$row['total_tr']."' class='sweet-confirm'><i class='fa fa-trash'></i></a>";
                  echo "</td>";
                  echo "</tr>";
              }
            ?>
