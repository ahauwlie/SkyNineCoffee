            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input name="jenis_diskon" id="jenis_diskon" type="text" maxlength="100" class="form-control" value="<?php echo $diskon['jenis_disc']; ?>" required>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
...
<script>
  $(function () {
    $('#jumlah_diskon').val('<?php echo $diskon['jum_disc']; ?>').trigger('change');
  })
</script>
