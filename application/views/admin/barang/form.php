  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    foreach($sheet as $row){ 
      ...
      if($numrow > 1){
        ...
        $nama_td = ( ! empty($nama_pr))? "" : " style='background: #E07171;'"; 
        $tipe_td = ( ! empty($tipe_pr))? "" : " style='background: #E07171;'"; 
        $harga_td = ( ! empty($harga_pr))? "" : " style='background: #E07171;'";
        $stock_td = ( ! empty($stock_pr))? "" : " style='background: #E07171;'"; 
        $tag_td = ( ! empty($tag_pr))? "" : " style='background: #E07171;'"; 
        $decs_td = ( ! empty($decs_pr))? "" : " style='background: #E07171;'";
        $img_td = ( ! empty($img_pr))? "" : " style='background: #E07171;'"; 
        ...
        echo "<tr>";
        echo "<td".$nama_td.">".$nama_pr."</td>";
        echo "<td".$tipe_td.">".$tipe_pr."</td>";
        echo "<td".$harga_td.">".$harga_pr."</td>";
        echo "<td".$stock_td.">".$stock_pr."</td>";
        echo "<td".$tag_td.">".$tag_pr."</td>";
        echo "<td".$decs_td.">".$decs_pr."</td>";
        echo "<td".$img_td.">".$img_pr."</td>";
        echo "</tr>";
      }
